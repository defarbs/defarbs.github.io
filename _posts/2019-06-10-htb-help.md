...
I notice port 80 and port 3000 right off the bat – typically I try to leave SSH alone towards the beginning if I can. The first thing I check out is the default web page at `http://10.10.10.121/`.