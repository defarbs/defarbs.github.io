...
Bingo! A basic "Google" (DuckDuckGo) search will display the CVE immediately! Alternatively, `searchsploit` can be used, but everybody likes screenshots, so that's what you're getting instead.
