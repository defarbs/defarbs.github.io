...
To replicate, I simply uploaded a PHP reverse shell (I am using `php-reverse-shell` from pentestmonkey) named `shell.php` and then ran the script to ensure it was uploaded successfully, like so:

<img src="/assets/img/writeups/HTB-HELP/submit_shell.PNG" class="submitshell-img" alt="Hack The Box - Help: Submit Shell">
