...
I went and ran a `gobuster` scan to enumerate potential web directories immediately after discovering the default `Apache` web page.
...
<img src="/assets/img/writeups/HTB-HELP/helpdeskz_scrnsht.PNG" class="helpdeskz-img" alt="Hack The Box - Help Homepage">
...
I managed to locate a `readme` file at `http://10.10.10.121/support.readme.html` which displays that this is `HelpDeskZ Version: 1.0.2 from 1st June 2015`. 
