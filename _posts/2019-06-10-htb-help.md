...
To replicate, I simply uploaded a PHP reverse shell (I am using `php-reverse-shell` from pentestmonkey) named `phpshell.php` and then ran the script to ensure it was uploaded successfully, like so:
