...
### Nmap Scan
<div class="highlighter-rouge"><div class="highlight"><pre class="highlight"><code>root@rattLR:~/HTB-HELP# nmap -sC -sV -A -Pn 10.10.10.121
...
<div align="center">
<!-- add the button! -->
<applause-button style="width: 58px; height: 58px;" color="#5d4d7a" url="defarbs.com/htb-help"/>
</div>
<div align="center">
