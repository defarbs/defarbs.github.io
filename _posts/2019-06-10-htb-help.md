...
I notice port 80 running an `Apache2` server and port 3000 running `Node.js Express Framework` right off the bat – typically I try to leave SSH alone towards the beginning if I can. The first thing I check out is the default web page at `http://10.10.10.121/`.